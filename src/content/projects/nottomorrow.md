...
Most planning tools ask you to do the planning. You still have to decide what
matters today, and that decision is the hard part. NotTomorrow flips that: you
tell it what's on your plate, and an AI planning engine builds the day for you.

## What I did

I built the entire product myself, end to end:

- **Product:** scoped the core loop (capture, plan, execute), designed the
...
what good looks like) were mine; the AI multiplied how fast I could act on
them.
...
Product design and scoping, full-stack development, AI-assisted development,
subscription billing, pricing, self-directed 0 to 1 execution.
